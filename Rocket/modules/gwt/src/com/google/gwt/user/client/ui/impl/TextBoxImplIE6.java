...
public class TextBoxImplIE6 extends TextBoxImpl {
   ...
   * 
   * This method includes a simple guard and adjusts selection length to ensure the above mentioned exceptions never happen.
   */
   ...
   * 
   * This hack fixes the case described above so the reported cursor position will point to the first char on a new line, rather than the end of the previous. The down side is you end of line cursors 
   * appear to be on the start of the next line.
   * 
