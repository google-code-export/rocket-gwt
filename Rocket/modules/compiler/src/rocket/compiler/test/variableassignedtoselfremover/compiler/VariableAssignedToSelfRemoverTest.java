 ...
 * the License.
 */
package rocket.compiler.test.variableassignedtoselfremover.compiler;
...
public class VariableAssignedToSelfRemoverTest extends VariableAssignedToSelfRemover {

	final static String MODIFIED = "variableAssignedToSelf";
	final static String UNMODIFIED = "leaveThisAssignmentAlone";
	...
	protected boolean removeAssignment(final JBinaryOperation binaryOperation, final Context context, final TreeLogger logger) {
		...
		return super.removeAssignment(binaryOperation, context, logger);
	}
