 ...
 * infrastructure. By having all logging statements less than fatal are empty
 * and thus will be removed from the generated output by the compiler.
 * 
 * @author Miroslav Pokorny
 */
public class FatalLevelLogger extends ErrorLevelLogger implements Logger {

	public FatalLevelLogger(final Logger logger) {
		super(logger);
	}

	protected FatalLevelLogger() {
		super();
	}
