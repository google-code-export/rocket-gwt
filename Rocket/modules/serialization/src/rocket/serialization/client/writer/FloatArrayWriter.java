...
public class FloatArrayWriter extends ObjectWriterImpl {
	...
	static public final ObjectWriter instance = new FloatArrayWriter();

	protected FloatArrayWriter() {
	}

	protected void write0(final Object object, final ObjectOutputStream objectOutputStream) {
		this.writeFloatArray((float[]) object, objectOutputStream);
	}

	protected void writeFloatArray(final float[] array, final ObjectOutputStream objectOutputStream) {
