 ...
 * generated SerializationFactory's to support the deserialization of instances.
 * 
...
abstract public class ClientObjectInputStream extends ObjectInputStreamImpl implements ObjectInputStream {
	...
	/**
	 * This JSO holds a javascript array that contains the result of evaling the
	 * given stream.
	 */
	private JavaScriptObject stream = null;

	/**
	 * An index into the stream that is used fetch the next token to be
	 * consumed.
	 */
	...
	// return this.@rocket.serialization.client.ClientObjectInputStream::stream[
	// this.@rocket.serialization.client.ClientObjectInputStream::valueIndex++
	// ];
	// }-*/;
