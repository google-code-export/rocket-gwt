...
public class ConcreteClassObjectReader extends ObjectReaderImpl implements ServerObjectReader {

	public boolean canRead(final Class classs) {
		return ConcreteClass.class.equals(classs);
	}
	...
	public void read(final Object instance, final ObjectInputStream objectInputStream) {
		final ConcreteClass concreteClass = (ConcreteClass) instance;
