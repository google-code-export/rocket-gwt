...
/**
 * BASE64 encoder implementation. This object takes as parameter an input stream and an output stream. It encodes the input stream, using
 * the BASE64 encoding rules, as defined in <a href="http://ds.internic.net/rfc/rfc1521.txt">MIME specification </a> and emit the resulting
...
public class Base64Encoder {
    ...
    private static byte encoding[] = { (byte) 'A', (byte) 'B', (byte) 'C', (byte) 'D', (byte) 'E', (byte) 'F',
            (byte) 'G', (byte) 'H', // 0-7
    ...
    /**
     * Process the data: encode the input stream to the output stream. This method runs through the input stream, encoding it to the output
     * stream.
     * 
     * @exception IOException
     *                If we weren't able to access the input stream or the output stream.
     */
    ...
    /**
     * Encode the content of this encoder, as a string. This methods encode the String content, that was provided at creation time,
     * following the BASE64 rules, as specified in the rfc1521.
     * 
