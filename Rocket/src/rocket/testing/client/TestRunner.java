...
/**
 * A TestRunner is the main class which coordinates the execution of tests.
 * It is also responsible for updating the ui or producing a report to detail the results of
 * executing some tests.
 * 
 * <h6>Advantages compared with GwtTestCase</h6>
 * <ul>
 * <li>Tests are not limited to purely the hosted mode browser of your development platform.</li>
 * <li>Tests are run are actually a regular module and thus a browser is always visible</li>
 ...
 * <li>
 * Because reflection is not available the user must build a list of available test methods.
 * This is the reason for the {@link TestBuilder#buildCandidates()} class and method.
 * </li>
 * 
...
abstract public class TestRunner {
    ...
    /**
     * A list returned by the test builder containing all the lists that will be executed.
     */
    private List tests;
    ...
    /**
     * Sub-classes can override this method to be notified of a new test starting.
     * @param test
     */
    ...
    /**
     * Sub-classes can override this method to be notified of a test finishing successfully
     * @param test
     */
    ...
    /**
     * Sub-classes can override this method to be notified of all tests completing.
     * @param test
     */
    abstract protected void onCompletion( int started, int passed, int failed, int aborted );
        
    /**
     * Sub-classes may override this method to do something different when a testSuite returns
     * no tests.
     */
    ...
    /**
     * When this flag is true and a test suite is being executed
     * all remaining tests will be skipped and the results tabulated.
     */
    ...
    /**
     * This method is called by the test dispatcher when it has been instructed to wait for a pending test.
     * 
     * A timer is executed which constantly checks every so often if the current test
     * has finished.
     * When the test has finish
     */
