...
public class SplitterItem {
    ...
    /**
     * THe minimum width in pixels that maybe allocated to this widget within the parent SplitterPanel
     */
    ...
    /**
     * The sizeShare value is used to determine how much space a new widget is allocated when added to a SplitterPanel.
     */
    ...
    /**
     * Removes this splitterItem from its parent Splitter provided it has already been added.
     */
    public void remove() {
