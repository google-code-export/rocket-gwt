...
/**
 * Provides a list view of all a form's elements. It also includes a centralised
 * factory method which creates various widgets depending on which tag was
 * encountered.
 * 
 * Because the form elements array is read only this list is also read only and
 * any attempts to use any of Lists modifying methods which result in an
 * exception being thrown.
 * 
 * @author Miroslav Pokorny (mP)
 */
class FormElementsList extends AbstractList implements Destroyable {
	...
	public Object get(final int index) {
		...
		while (true) {
			final Element element = (Element) ObjectHelper.getElement(this.getFormElements(), index);
	...
	protected Widget createWidget(final Element element) {
		...
		while (true) {
			if (Dom.isTag(element, FormConstants.INPUT_TAG)) {
				final String type = DOM.getElementProperty(element, FormConstants.INPUT_TAG_TYPE);
			...
			if (Dom.isTag(element, FormConstants.BUTTON_TAG)) {
	...
	/**
	 * This method is called whenever an unknown/unhandled input element is
	 * encountered.
	 * 
	 * @param element
	 */
	...
	/**
	 * This method is called whenever an unknown/unhandled element is
	 * encountered.
	 * 
	 * @param element
	 */
	...
	/**
	 * Factory method which creates a TextBox given a input element of type
	 * text.
	 * 
	 * @param element
	 * @return
	...
	class TextBox extends com.google.gwt.user.client.ui.TextBox {
		...
		protected void setElement(final Element element) {
			Dom.checkInput("parameter:element", element, FormConstants.TEXT_TYPE);
	...
	/**
	 * Factory method which creates a PasswordTextBox given a input element of
	 * type password.
	 * 
	 * @param element
	 * @return
	...
	class Password extends com.google.gwt.user.client.ui.PasswordTextBox {
		...
		protected void setElement(final Element element) {
			Dom.checkInput("parameter:element", element, FormConstants.PASSWORD_TYPE);
			super.setElement(element);
		}
	...
	class TextArea extends com.google.gwt.user.client.ui.TextArea {
		...
		protected void setElement(final Element element) {
			Dom.checkTagName("parameter:element", element, FormConstants.TEXTAREA_TAG);
			super.setElement(element);
		}
	...
	class CheckBox extends com.google.gwt.user.client.ui.CheckBox {
		...
		// protected void setElement( final Element element ){
		// Dom.checkInput( "parameter:element", element,
	...
	class Button extends com.google.gwt.user.client.ui.Button {
		...
		protected void setElement(final Element element) {
			Dom.checkTagName("parameter:element", element, FormConstants.BUTTON_TAG);
			super.setElement(element);
		}
	...
	class ListBox extends com.google.gwt.user.client.ui.ListBox {
		...
		// protected void setElement( final Element element ){
		// Dom.checkTagName( "parameter:element", element,
