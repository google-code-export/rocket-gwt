...
/**
 * The SubmitButton widget represents a button abstraction of a Submit button
 * that is typically part of a form.
 * 
...
public class SubmitButton extends ButtonBase {
	...
	static Element createElement() {
		...
		DOM.setElementProperty(element, FormConstants.INPUT_TAG_TYPE, FormConstants.SUBMIT_BUTTON_TYPE);
		return element;
	}
	...
	protected void setElement(final Element element) {
		Dom.checkInput("parameter:element", element, FormConstants.SUBMIT_BUTTON_TYPE);
