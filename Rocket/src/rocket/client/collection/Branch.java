...
public class Branch {
	...
	/**
	 * Puts the given value into this branch or a sub-branch. This may result in
	 * a previous branch having its value replaced or a new branch added to this
	 * or another sub-branch.
	 *
	 * @param path
	 * @param value
	...
	/**
	 * Gets the value of the branch at the given path. If the path does not
	 * previously exist an exception will be thrown.
	 *
	 * @param path
	 * @return
	 */
	...
	/**
	 * Removes any branch or branch that matches the given path. If a branch is
	 * removed its children and those underneath them are also removed.
	 *
	 * @param path
	 */
	...
	/**
	 * Removes only the branch holding the path. No chidren of teh branch are
	 * lost, they are simply moved to a new branch.
	 *
	 * @param path
	...
	/**
	 * Scans the children of this branch for a child using the given path. It
	 * ignores any branches that are parents.
	 *
	 * @param path
	 * @return
	 */
