...
public class DoubleArrayWriterTestCase extends ServerTestCase {

	final static String DOUBLE_ARRAY = double[].class.getName();

	final static double DOUBLE_VALUE = 34.5;

	public void testWriteDoubleArray() {
		final TestServerObjectOutputStream output = createObjectOutputStream(DoubleArrayWriter.instance);
