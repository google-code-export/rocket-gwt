...
/**
 * This response captures all bytes or characters written to it. This is achieved by returning special Writers/OutputStream. Cookies
 * are not captured and are added to the wrapped response, all other headers are simply captured in a map.
 *
