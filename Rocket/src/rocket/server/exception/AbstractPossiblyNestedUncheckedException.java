 ...
 * @version 1.0
 */
public abstract class AbstractPossiblyNestedUncheckedException extends RuntimeException {
    /**
     ...
     */
    protected AbstractPossiblyNestedUncheckedException(final String message, final Throwable cause) {
        super();
        this.setMessage(message);
        this.setCause(cause);
    }
    ...
    public String getMessage() {
        ...
        return ExceptionHelper.buildExceptionMessageWithPossibleNullCause(message, this.getCause());
    } // getMessage
