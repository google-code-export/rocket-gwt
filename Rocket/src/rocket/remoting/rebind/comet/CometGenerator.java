 ...
 * the necessary
 * 
 * This generator reads the createDeserializer method of CometClient and creates two
 * GWT RPC interfaces for the annotated type.
 * 
...
public class CometGenerator extends Generator {
	 ...
	 * 
	 * @param newType The enclosing type that will contain the service interface
	 */
	...
	/**
	 * Creates the async service interface counterpart for the rpc service interface generated
	 * by {@link #createRpcServiceInterface(NewConcreteType)} 
	 * @param newType The enclosing type that will contain the async service interface
	 */
	...
	/**
	 * Retrieves the type after reading the type from an annotation belonging to the createDeserializer method.
	 * 
	 * @param list
	 * @param annotation
	 * @return
	...
	/**
	 * Implements the outstanding createDeserializer method to return a reference to the payload serializer.
	 * @param newType The type that will contain the new realised createDeserializer method.
	 */
