 ...
 * the License.
 */
package rocket.util.test.stacktracehelper.test;
...
public class StackTraceHelperGwtTestCase extends GWTTestCase {
    ...
    public void testGetStackTraceAsString() {
        ...
        assertTrue(stackTrace + "\n" + firstStackElement, -1 != firstStackElement
                .indexOf("oneFrameAwayFromMethodWhichThrowsException"));
        ...
        assertTrue(stackTrace + "\n" + fourthStackElement, -1 != fourthStackElement.indexOf(thisClassName
