 ...
 * the License.
 */
package rocket.test.widget.tree.client;
...
public class TreeTest implements EntryPoint {
	...
	public void onModuleLoad() {
		try {
			...
			tree.setCollapserImageUrl("/tree/collapser.gif");
			tree.setExpanderImageUrl("/tree/expander.gif");
			tree.addTreeListener(new TreeListener() {
				...
				public String toString(final TreeItem treeItem) {
					return DOM.getInnerText(treeItem.getMainWidget()
							.getElement());
				}
			});
		...
		protected void insertWidget(final Widget widget, final int beforeIndex) {
			...
			insertTreeItemBefore.addClickListener(new ClickListener() {
				public void onClick(final Widget widget) {
					...
					newChild.setMainWidget(new HTML("TreeItem-"
