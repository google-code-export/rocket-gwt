 ...
 * 
 * @mP - added isFinal() method required by various generators.
 */
public class JClassType extends JType implements HasMetaData {
   ...
   * {@link ConcreteClass#getMethod(String, ConcreteClass[])}, which does not return the most
   ...
   * @return
   * 
   * FIXME added by Miroslav Pokorny
   */
