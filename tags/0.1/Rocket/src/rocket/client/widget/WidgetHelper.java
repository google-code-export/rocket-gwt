...
public class WidgetHelper extends SystemHelper {
    ...
    /**
     * Given an element attempts to find which widget it is a child of. This is particularly useful when a panel contains many
     * widgets which in themselves are made up of many elements and one needs to determine which widget the
     * event belongs too.
     * @param target
     * @param widgets
	 ...
	 * @param toColour
	 */
	public static void verticalGradientFill(final PixelGrid grid,
			final int left, final int top, final int right, final int bottom,
			final int topColour, final int bottomColour) {
	...
	public static void horizontalGradientFill(final PixelGrid grid,
			final int left, final int top, final int right, final int bottom,
			final int fromColour, final int toColour) {
		gradientFill(grid, left, top, right, bottom, fromColour, toColour,
				fromColour, toColour);
	}
	 ...
	 */
	public static void gradientFill(final PixelGrid grid, final int left,
			final int top, final int right, final int bottom,
			final int topLeftColour, final int topRightColour,
			final int bottomLeftColour, final int bottomRightColour) {
