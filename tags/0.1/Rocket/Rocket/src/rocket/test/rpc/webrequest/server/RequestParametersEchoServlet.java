 ...
 * the License.
 */
package rocket.test.rpc.webrequest.server;
...
/**
 * This servlet simply echos all request parameters in alphabetical order using a line for each parameter. The first line however
 * contains the method type. GET and POST requests are processed in the same manner.
 *
