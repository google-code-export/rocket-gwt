 ...
 * the License.
 */
package rocket.test.dom.abstractelementlist.test;
 ...
 */
public class AbstractElementListTestCase extends GWTTestCase {
  ...
  public String getModuleName() {
    return "rocket.test.dom.abstractelementlist.Test";
  }
