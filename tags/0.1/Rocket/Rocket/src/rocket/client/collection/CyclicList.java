...
public class CyclicList extends AbstractList implements List{
	...
	public void setCapacity( final int capacity ){
		...
		if( capacity != currentCapacity ){
			...
			// copy over elements from the current elements array to the newElements array.
	...
	protected void insert( final int index, final Object element ){
		...
		// increase size - this should help avoid problems during translateIndex.
		this.setSize( size + 1 );
	...
	/**
	 * This counter keeps track and is increment each time the list has an element added or removed.
	 * It is used to provide a failfast iterator.
	 */
	...
	public String toString(){
		return super.toString() + ", elements: " + this.elements + ", firstIndex: " + firstIndex + ", lastIndex: " + lastIndex +
