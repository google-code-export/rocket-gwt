...
/**
 * This FlexTable adds automatic support for a zebra effect automatically applying an odd / even style to a row
 * depending on whether the row is an odd or even one.
...
public class ZebraFlexTable extends FlexTable {
	...
	protected void updateRowBackgroundColour( final int row ){
      ...
      final String addStyle = oddRow ? WidgetConstants.ZEBRA_FLEX_TABLE_ODD_ROW_STYLE : WidgetConstants.ZEBRA_FLEX_TABLE_EVEN_ROW_STYLE;
      formatter.addStyleName( row, addStyle );

      final String removeStyle = oddRow ? WidgetConstants.ZEBRA_FLEX_TABLE_EVEN_ROW_STYLE : WidgetConstants.ZEBRA_FLEX_TABLE_ODD_ROW_STYLE;
