...
/**
 * A variety of helper and assertions relating to working with Throwable
 * objects.
 *
...
public class ExceptionHelper {
	...
	public static boolean isChecked(final Throwable throwable) {
		...
		return throwable instanceof Exception
				&& (false == (throwable instanceof RuntimeException));
	}
	...
	public static void assertChecked(final String name,
		...
		if (ExceptionHelper.isUnchecked(throwable)) {
			SystemHelper
					.handleAssertFailure(
							...
							"The "
									+ name
									+ " is unchecked and when it should be checked, throwable: "
									+ throwable);
		}
	}

	public static void assertUnchecked(final String name,
			final Throwable throwable) {
		if (ExceptionHelper.isChecked(throwable)) {
			SystemHelper
					.handleAssertFailure(
							...
							"The "
									+ name
									+ " is checked and when it should be unchecked, throwable: "
									+ throwable);
		}
	}
	...
	protected static String stackTraceToStringUsingPrintWriter(
			final Throwable throwable) {
		ObjectHelper.checkNotNull("parameter:throwable", throwable);
	...
	/**
	 * Accepts any subclass of Throwable and returns a checked or Exception,
	 * wrapping the given throwable if necessary.
	 *
	 * @param throwable
	 *            Any exception
	 * @return a Exception
	...
	public static Exception makeIntoException(final Throwable throwable) {
		...
		return throwable instanceof Exception ? (Exception) throwable
				: new CheckedNestedException(throwable);
	}

	/**
	 * Accepts any subclass of Throwable and returns a unchecked or runtime
	 * exception, wrapping the given throwable if necessary.
	 *
	 * @param throwable
	 *            Any exception
	 * @return a RuntimeException
	 */
	public static RuntimeException makeIntoUncheckedException(
			final Throwable throwable) {
		ObjectHelper.checkNotNull("parameter:throwable", throwable);
	 ...
	 * @return String
	 */
	public static String buildExceptionMessage(final String wrapperMessage,
	...
	public static String buildExceptionMessageWithPossibleNullCause(
			final String wrapperMessage, final Throwable cause) {
		String causeMessage = null;
		if (cause != null) {
			causeMessage = cause.getMessage();
		}

		final boolean hasWrapperMessage = !StringHelper
				.isNullOrEmpty(wrapperMessage);
		final boolean hasCauseMessage = !StringHelper
				.isNullOrEmpty(causeMessage);
