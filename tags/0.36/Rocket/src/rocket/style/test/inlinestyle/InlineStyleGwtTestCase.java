 ...
 * 
 * For the sake of brevity and simplicity none of the tests below attempt to
 * destroy any of the referenced Style objects.
 * 
...
public class InlineStyleGwtTestCase extends GWTTestCase {
	...
	/**
	 * Factory method which creates and adds a new div element to the document's
	 * body.
	 * 
	 * @return
	 */
