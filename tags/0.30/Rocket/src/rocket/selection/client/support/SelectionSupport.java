...
abstract public class SelectionSupport {
    ...
    public boolean isEnabled(final Element element) {
        return StyleConstants.USER_SELECT_ENABLED.equals(StyleHelper.getComputedStyleProperty(element,
                StyleConstants.USER_SELECT));
    }
    ...
    public SelectionEndPoint getStart() {
        ...
        start.setTextNode(ObjectHelper.castToElement(ObjectHelper.getObject(selection,
                SelectionSupportConstants.ANCHOR_NODE)));
    ...
    public SelectionEndPoint getEnd() {
        ...
        end.setTextNode(ObjectHelper.castToElement(ObjectHelper.getObject(selection,
                SelectionSupportConstants.FOCUS_NODE)));
