 ...
 */
public class LongArrayReader extends ObjectReaderImpl implements ObjectReader {
	static public final ObjectReader instance = new LongArrayReader();
	...
	public Object newInstance(final String typeName, final ObjectInputStream objectInputStream) {
		...
		final long[] array = new long[elementCount];
		for (int i = 0; i < elementCount; i++) {
			array[i] = objectInputStream.readLong();
		}
		return array;
	}
}
