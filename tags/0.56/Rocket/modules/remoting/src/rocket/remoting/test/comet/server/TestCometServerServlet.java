...
public class TestCometServerServlet extends CometServerServlet {
	...
	/**
	 * Adds a guard to send a 500 and drop the connection if the query to
	 * {@link CometServerActionServiceImpl#isFailNextConnection()} returns true.
	 * Otherwise the request continues so that the comet server can do its
	 * thing.
	 */
