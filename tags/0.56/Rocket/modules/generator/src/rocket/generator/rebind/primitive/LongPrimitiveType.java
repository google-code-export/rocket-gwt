...
/**
 * A common base class to represent the long primitive
 * 
...
abstract public class LongPrimitiveType extends PrimitiveType {
	...
	public boolean isAssignableTo(final Type type) {
		return this.equals(type) || this.getLong().equals(type) || this.getFloat().equals(type) || this.getDouble().equals(type);
	}

	public Type getWrapper() {
		return this.getType(Constants.LONG_WRAPPER);
	}
