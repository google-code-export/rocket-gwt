...
public class WidgetHelper extends SystemHelper {
	 ...
	 * @param toColour
	 */
	public static void verticalGradientFill(final PixelGrid grid, final int left, final int top, final int right, final int bottom,
			final Colour fromColour, final Colour toColour) {
	...
	public static void horizontalGradientFill(final PixelGrid grid, final int left, final int top, final int right, final int bottom,
			final Colour fromColour, final Colour toColour) {
		gradientFill(grid, left, top, right, bottom, fromColour, toColour, fromColour, toColour);
	}

	/**
	 * Fills the given window within the given grid with a mixture of the
	 * colours given.
	 * 
	 * @param grid
	 * @param left
	 ...
	 */
	public static void gradientFill(final PixelGrid grid, final int left, final int top, final int right, final int bottom,
			final Colour topLeftColour, final Colour topRightColour, final Colour bottomLeftColour, final Colour bottomRightColour) {
