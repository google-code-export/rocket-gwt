...
public class ConcreteSubClassObjectReader extends ConcreteClassObjectReader {
	...
	public void read(final Object instance, final ObjectInputStream objectInputStream) {
		final ConcreteSubClass instance0 = (ConcreteSubClass) instance;
		instance0.value2 = objectInputStream.readInt();

		super.read(instance0, objectInputStream);
	}
}
