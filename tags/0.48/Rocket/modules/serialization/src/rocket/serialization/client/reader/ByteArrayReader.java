 ...
 */
public class ByteArrayReader extends ObjectReaderImpl implements ObjectReader {
	static public final ObjectReader instance = new ByteArrayReader();
	...
	public Object newInstance(final String typeName, final ObjectInputStream objectInputStream) {
		...
		final byte[] array = new byte[elementCount];
		for (int i = 0; i < elementCount; i++) {
			array[i] = objectInputStream.readByte();
		}
		return array;
	}
}
