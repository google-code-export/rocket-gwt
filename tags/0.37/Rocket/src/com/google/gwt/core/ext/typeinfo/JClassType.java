...
public class JClassType extends JType implements HasMetaData {
	...
	public JClassType(TypeOracle oracle, CompilationUnitProvider cup, JPackage declaringPackage, JClassType enclosingType,
			boolean isLocalType, String name, int declStart, int declEnd, int bodyStart, int bodyEnd, boolean isInterface) {
	...
	private void getOverridableMethodsOnSuperclassesAndThisClass(Map methodsBySignature) {
		assert (isClass() != null);
	 ...
	 * @return
	 * 
	 * Added by Miroslav Pokorny for the rocket-gwt project. TODO When upgrading
	 * GWT version reapply changes to this class.
	 */
