 ...
 * 
 * It also includes an interactive set of buttons that creates an iterator,
 * queries if the iterator hasNext, visits the next element from the iterator
 * and removes the last visited element. A small area on the page is allocated
...
public class TreeTest implements EntryPoint {
	...
	/**
	 * A specialised TreeItem that adds various buttons to each newly added
	 * child widget each when clicked add siblings either before or after or
