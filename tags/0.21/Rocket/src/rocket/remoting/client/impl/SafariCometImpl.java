 ...
 * the License.
 */
package rocket.remoting.client.impl;
...
/**
 * This CometImpl contains a number of customisations to handle Safari quirks.
 * 
 * @author Miroslav Pokorny (mP)
 */
public class SafariCometImpl extends CometImpl {    
    /**
     * Because safari does not support an onload event or equivalent a timer is used to poll the status of
     * the iframe.
     */
   ...
   /**
    * Standards compliant browsers dont need to anything extra to stop a comet session other than to
    * destroy and deattach the hidden frame.
    * @param owner
    * @param frame
    */
   ...
   /**
    * This javascript checks and kills the associated onloadPoller function which polls the ready state of
    * the iframe. This is necessary as Safari does not appear to support any of the listener methods used
