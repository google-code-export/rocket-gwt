...
/**
 * This widget provides a simple list of pages shown as numbers.
 * THe user may click on any page and which time an event is fired to notify listeners.
 * This widget allows easy creation of the page numbering that appears at the bottom of all Google searches.
...
public class Pager extends AbstractNumberHolder implements NumberHolder {
	...
	protected HorizontalPanel createHorizontalPanel() {
		WidgetHelper.checkNotAlreadyCreated("field:horizontalPanel", this
				.hasHorizontalPanel());
	...
	protected Button createPage(final String label, final int pageNumber) {
		...
		PrimitiveHelper.checkBetween("parameter:pageNumber", pageNumber,
	...
	public int getCurrentPage() {
		PrimitiveHelper.checkBetween("field:currentPage", this.currentPage,
				this.firstPage, this.lastPage);
		return this.currentPage;
	}

	public void setCurrentPage(final int currentPage) {
		PrimitiveHelper.checkBetween("parameter:currentPage", currentPage,
				this.firstPage, this.lastPage);
	...
	public String toString() {
		return super.toString() + ", currentPage: " + currentPage
