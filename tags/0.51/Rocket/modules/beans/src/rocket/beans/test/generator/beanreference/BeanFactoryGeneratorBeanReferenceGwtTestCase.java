...
public class BeanFactoryGeneratorBeanReferenceGwtTestCase extends GeneratorGwtTestCase {
	...
	public void testReferencesBeanWhichIsAProductOfFactoryBean() {
		final ReferencesFactoryBeanBeanFactory beanFactory = (ReferencesFactoryBeanBeanFactory) GWT
				.create(ReferencesFactoryBeanBeanFactory.class);
	...
	public void testComplex() {
		...
		final rocket.beans.test.generator.beanreference.complex.HasProductOfFactoryBean hasProductOfFactoryBean = (rocket.beans.test.generator.beanreference.complex.HasProductOfFactoryBean) beanFactory
				.getBean("hasProductOfFactoryBean");
		...
		final rocket.beans.test.generator.beanreference.complex.HasProductOfFactoryBean hasProductOfNestedFactoryBean = (rocket.beans.test.generator.beanreference.complex.HasProductOfFactoryBean) beanFactory
				.getBean("hasProductOfNestedFactoryBean");
