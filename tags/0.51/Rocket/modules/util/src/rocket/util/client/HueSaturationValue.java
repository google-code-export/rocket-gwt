...
public class HueSaturationValue {
	...
	public HueSaturationValue(final float hue, final float saturation, final float value) {
		super();
	...
	public int hashCode() {
		return ((int) this.getHue() * 256 * 256 * 256) ^ ((int) this.getSaturation() * 256 * 256) ^ ((int) this.getValue() * 256);
	}
