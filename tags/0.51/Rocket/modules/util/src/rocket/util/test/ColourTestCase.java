...
public class ColourTestCase extends TestCase {
	...
	public void testAsHueSaturationValue() {
	...
	static boolean equals(final float hue, final float saturation, final float value, final HueSaturationValue hueSaturationValue) {
