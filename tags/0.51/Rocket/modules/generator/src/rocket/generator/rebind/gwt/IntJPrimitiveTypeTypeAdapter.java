...
import rocket.generator.rebind.primitive.IntPrimitiveType;

import com.google.gwt.core.ext.typeinfo.JPrimitiveType;

/**
 * A singleton that presents the primitive int type.
 * 
 * @author Miroslav Pokorny
 */
public class IntJPrimitiveTypeTypeAdapter extends IntPrimitiveType {

	public IntJPrimitiveTypeTypeAdapter( final TypeOracleGeneratorContext context ){
		super();
