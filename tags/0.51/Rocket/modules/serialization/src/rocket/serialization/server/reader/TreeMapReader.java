...
/**
 * A reader for TreeMap implementations
 * 
 * @author Miroslav Pokorny
 */
public class TreeMapReader extends rocket.serialization.client.reader.MapReader implements ServerObjectReader {

	static public final ServerObjectReader instance = new TreeMapReader();

	protected TreeMapReader() {
	}
