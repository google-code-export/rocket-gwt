 ...
 * 
 * ROCKET
 * This class includes a few guards to ensure that the iterator fails fast.
 */
 ...
 * 
 * <p>
 * The main purpose of this specialized collection is to implement {@link java.util.Iterator#remove()} in a way that delegates removal to
 * its panel. This makes it much easier for the panel to implement an {@link com.google.gwt.user.client.ui.HasWidgets#iterator() iterator}
 * that supports removal of widgets.
 * </p>
 */
public class WidgetCollection {
     ...
     * 
     * @param parent
     *            the container whose {@link HasWidgets#remove(Widget)} will be delegated to by the iterator's {@link Iterator#remove()}
     *            method.
     */
    public WidgetCollection(HasWidgets parent) {
        ...
        this.setModificationCounter(0);// ROCKET
    }
    ...
    public void insert(Widget w, int beforeIndex) {
        ...
        this.incrementModificationCounter();// ROCKET
    }

    /**
     * Gets an iterator on this widget collection. This iterator is guaranteed to implement remove() in terms of its containing
     * {@link HasWidgets}.
     * 
     * @return an iterator
     * 
     * This method has been modified to return an IteratorView which takes care of concurrentmodification issues.
     */
    public Iterator iterator() {
        final Iterator wrapped = new WidgetIterator();
        final IteratorView iterator = new IteratorView() {
            ...
            protected int getModificationCounter() {
                return WidgetCollection.this.getModificationCounter();
            }
        };
    ...
    // ROCKET variable added to assist with failing fast...
