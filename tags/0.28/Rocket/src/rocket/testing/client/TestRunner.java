...
/**
 * A TestRunner is the main class which coordinates the execution of tests. It is also responsible for updating the ui or producing a report
 * to detail the results of executing some tests.
 * 
 ...
 * <li> Because reflection is not available the user must build a list of available test methods. This is the reason for the
...
abstract public class TestRunner {
    ...
    /**
     * Sub-classes may override this method to do something different when a testSuite returns no tests.
     */
    ...
    /**
     * When this flag is true and a test suite is being executed all remaining tests will be skipped and the results tabulated.
     */
     ...
     * 
     * A timer is executed which constantly checks every so often if the current test has finished. When the test has finish
     */
