 ...
 * the License.
 */
package rocket.test.widget.orderedlistpanel.client;

import java.util.Iterator;

import rocket.client.util.SystemHelper;
import rocket.client.widget.OrderedListPanel;
...
public class OrderedListPanelTest implements EntryPoint {
    ...
    public void onModuleLoad() {
        ...
        final OrderedListPanel panel = new OrderedListPanel();
        rootPanel.add(panel);
