...
/**
 * This class should not be used by client code and exists only to help the emulated Throwable class capture and build
 * Throwables with populated StackTraceElements.
 * 
...
public class ThrowableHelper {
    ...
    native public static JavaScriptObject getCallStackFunctions() /*-{
     var elements = [];
     var i =  0;
     var context = @rocket.util.client.ThrowableHelper::getCallStackFunctions();
