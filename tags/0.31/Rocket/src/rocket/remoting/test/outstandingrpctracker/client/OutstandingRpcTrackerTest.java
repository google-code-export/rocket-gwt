...
public class OutstandingRpcTrackerTest implements EntryPoint {
    ...
    public void onModuleLoad() {
        ...
        DOM.setStyleAttribute(loadingElement, StyleConstants.BACKGROUND_COLOR, "red");
        DOM.setStyleAttribute(loadingElement, StyleConstants.COLOR, "white");
        DOM.setStyleAttribute(loadingElement, StyleConstants.POSITION, "absolute");
        DOM.setStyleAttribute(loadingElement, StyleConstants.RIGHT, "0px");
        DOM.setStyleAttribute(loadingElement, StyleConstants.TOP, "0px");
