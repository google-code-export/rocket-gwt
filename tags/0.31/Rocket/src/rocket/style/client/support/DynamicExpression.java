...
/**
 * This class exists primarily to assist the InternetExplorer6StyleSupport class with building and extracting expressions to simulate fixed
 * positioning for IE.
 * 
...
public class DynamicExpression {
    ...
    /**
     * Replaces the placeholders within the expression with the given value and returned the final result.
     * 
     * @param value
     * @return
     */
    ...
    /**
     * Extracts the number at the position of the placeholder from a prepopulated expression.
     * 
     * @return
     */
    ...
    /**
     * Compares a text which possibly contains a dynamic expression less the substituted values.
     * 
     * @param text
     * @return
     */
