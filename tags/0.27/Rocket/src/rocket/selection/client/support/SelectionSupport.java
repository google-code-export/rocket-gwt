...
abstract public class SelectionSupport {
    ...
    public void setEnabled( final Element element, final boolean enable ){
        if( enable ){
            StyleHelper.removeInlineStyleProperty( element, StyleConstants.USER_SELECT);        
        }else{
    ...
    public boolean isEnabled( final Element element ){       
        return StyleConstants.USER_SELECT_ENABLED.equals( StyleHelper.getComputedStyleProperty(element, StyleConstants.USER_SELECT ));
    }
    ...
    public SelectionEndPoint getStart(){
        ...
        start.setTextNode( ObjectHelper.castToElement( ObjectHelper.getObject(selection, SelectionSupportConstants.ANCHOR_NODE)));
        start.setOffset( ObjectHelper.getInteger(selection, SelectionSupportConstants.ANCHOR_OFFSET ));
        return start;
    }
    ...
    public SelectionEndPoint getEnd(){
        ...
        end.setTextNode( ObjectHelper.castToElement( ObjectHelper.getObject(selection, SelectionSupportConstants.FOCUS_NODE)));
        end.setOffset( ObjectHelper.getInteger(selection, SelectionSupportConstants.FOCUS_OFFSET ));
        return end;
    }
    ...
    public boolean isEmpty(){
        return ObjectHelper.getBoolean( this.getNativeSelection(), SelectionSupportConstants.IS_COLLAPSED );
    }
    ...
    /**
     * Sub-classes must implement this method to return a reference to the documents selection object.
     * 
     * An abstract method is necessary because each of the browsers have their respective selection object in different parts of the DOM.
     * 
     * @return
     */
    ...
    /**
     * Extracts any selection and makes it a child of an element not attached to the DOM.
     * @param element
     */
