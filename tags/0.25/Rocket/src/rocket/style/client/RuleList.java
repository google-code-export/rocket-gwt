...
class RuleList extends AbstractList {
    ...
    /**
     * Performs two tasks, verifies that the index is valid (it throws an exception if its not) and also expands the wrappers list to have
     * enough elements to match the passed index.
     * 
     * @param index
     */
