 ...
 */
public class DoubleArrayReader extends ObjectReaderImpl implements ObjectReader {

	static public final ObjectReader instance = new DoubleArrayReader();
	...
	public Object newInstance(final String typeName, final ObjectInputStream objectInputStream) {
		...
		for (int i = 0; i < elementCount; i++) {
			array[i] = objectInputStream.readDouble();
		}
		return array;
	}
}
