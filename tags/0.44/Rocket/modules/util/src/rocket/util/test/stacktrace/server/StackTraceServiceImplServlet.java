 ...
 * the License.
 */
package rocket.util.test.stacktrace.server;

import rocket.util.test.stacktrace.client.ServerServiceException;
import rocket.util.test.stacktrace.client.StackTraceTestService;
 ...
 */
public class StackTraceServiceImplServlet extends RemoteServiceServlet implements StackTraceTestService {
