...
public class ConcreteSubClassObjectWriter extends ConcreteClassObjectWriter implements ObjectWriter {

	protected void write0(final Object object, final ObjectOutputStream objectOutputStream) {
		final ConcreteSubClass concreteSubClass = (ConcreteSubClass) object;
		objectOutputStream.writeInt(concreteSubClass.value2);
