...
/**
 * A custom writer that writes all fields above Throwable using reflection but writes fields belonging to the emulated
 * Throwable in a format that is compatible with the {@link rocket.serialization.client.reader.ObjectReader}.
 *  
...
public class ThrowableWriter extends ReflectiveWriter implements ServerObjectWriter {
	...
	protected void writeFields(final Object throwable, final Class classs, final ObjectOutputStream objectOutputStream ) throws IllegalAccessException {
