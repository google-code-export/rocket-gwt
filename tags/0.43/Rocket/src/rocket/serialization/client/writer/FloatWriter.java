...
public class FloatWriter extends NumberWriter implements ObjectWriter{
	...
	protected void write0(final Object object, final ObjectOutputStream objectOutputStream) {
		this.writeFloat((Float) object, objectOutputStream);
	}

	protected void writeFloat(final Float wrapper, final ObjectOutputStream objectOutputStream) {
		objectOutputStream.writeFloat(wrapper.floatValue());
	}
