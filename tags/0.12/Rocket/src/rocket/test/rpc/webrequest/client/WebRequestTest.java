 ...
 * HttpServletRequest and HttpServletResponse which means the WebRequest always fails.
 *
    	...
    	service.doRequest( request, new AsyncCallback(){
            ...
            public void onSuccess(final Object result) {
            	...
            	if( ! expectedBody.equals( expectedBody )){
            		addFailure("The response returned an incorrect content, expected[" + expectedBody + "], actual[" + actualBody + "]");
            	}
            }
    	});
    }
