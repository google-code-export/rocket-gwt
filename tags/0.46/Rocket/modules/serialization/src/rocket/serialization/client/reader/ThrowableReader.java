 ...
 * 
 * The following components of {@link java.lang.Throwable} are serialized in the following sequence.
 * <ol>
 * <li>message</li>
 * <li>cause</li>
 ...
 * </ol>
 *
 * The following components of {@link java.lang.StackTraceElement} are serialized in the following sequence.
 * <ol>
 * <li>class name</li>
 * <li>method name</li>
 * <li>file name</li>
...
public class ThrowableReader extends ObjectReaderImpl implements ObjectReader {
	...
	public void readFields(final Throwable throwable, final ObjectInputStream objectInputStream) {		
		...
		// dont save if in hosted mode because these fields dont exist on the jdk Throwable, they only exist on the emulated version. 
		if ( GWT.isScript()) {
	...
	/**
	 * This method should only be called in script mode (not hosted mode) as it attempts to update the fields on the emulated Throwable class which dont exist in hosted mode.
	 * @param throwable
	 * @param message
	 * @param cause
	 * @param elements
	 */
	protected void updateEmulatedThrowableFields( final Throwable throwable, final String message, final Throwable cause, final StackTraceElement[] elements ){
