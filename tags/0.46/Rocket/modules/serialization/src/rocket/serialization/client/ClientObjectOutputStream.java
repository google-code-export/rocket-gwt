...
/**
 * This type is typically never instantiated by user code but only leveraged by generated SerializationFactory's to support the serialization of objects.
 *
 * To achieve maximum performance jsni is used, eg rather than mapping typeNames to ObjectWriters the generator uses a switch statement to locate an ObjectWriter
...
abstract public class ClientObjectOutputStream extends ObjectOutputStreamImpl {
	...
	/**
	 * This method will be implemented by the SerializationFactoryGenerator to return the right ObjectWriter for the given type name.
	 * 
	 * If an ObjectWriter was not found an exception will be thrown via {@link #throwUnableToSerializable(String)}.
	 * @param typeName The name of the type about to be serialized.
	 ...
	 * 
	 * A string containing ":" and the identity hashcode of the object is used as the key
	 * with the reference held as the value.
	 */
