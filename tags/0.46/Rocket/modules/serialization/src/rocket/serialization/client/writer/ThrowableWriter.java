 ...
 * 
 * It includes a special case if the environment is running hosted mode, ie the message, cause and stack trace elements 
 * will not be read from the instance but dummy null values will be written in their place.
 * 
...
public class ThrowableWriter extends ObjectWriterImpl {
	...
	/**
	 * This method handles the writing of Throwable in hosted mode by writing null entries for each of the emulated Throwable fields.
	 * @param throwable The instance being serialized
	 * @param objectOutputStream The outputstream being written too
	 */
	...
	/**
	 * This method is only invoked in script mode and uses jsni to read various emulated Throwable fields before serializing them.
	 * @param throwable The instance being serialized
	 * @param objectOutputStream The outputstream being written too
	 */
