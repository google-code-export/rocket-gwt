...
public class DelayedBranchLoggerTestCase extends TestCase {
	...
	public void testBranch(){
		...
		final TreeLogger branch = TreeLoggers.delayedBranch(capturer, TreeLogger.DEBUG, "1", null );
	...
	public void testDelayedBranchThenRegularBranchLeafLog(){
		...
		final TreeLogger delayedBranch = TreeLoggers.delayedBranch(capturer, TreeLogger.DEBUG, "1", null );
		assertEquals( 0, messages.size() );
	...
	public void testTwoBranchesThenLeafLog(){
		...
		final TreeLogger branchOfBranch = TreeLoggers.delayedBranch(branch, TreeLogger.DEBUG, "2", null );
		assertEquals( "" + messages, 0, messages.size() );
	...
	public void testTwoBranchesThenBranchLogSecondBranchAttemptIsLost(){
		...
		final TreeLogger branchBranch = TreeLoggers.delayedBranch(branch, TreeLogger.DEBUG, "2", null ); // lost
		assertEquals( "" + messages,0, messages.size() );
	...
	public void testTwoBranchesThenBranchLogThenBranchBranchLog(){
		...
		final TreeLogger branchBranch = TreeLoggers.delayedBranch(branch, TreeLogger.DEBUG, "2", null );
		assertEquals( "" + messages,0, messages.size() );
	...
	public void testThreeBranchesThenOneLeafLog(){
		...
		final TreeLogger branchBranchBranch = TreeLoggers.delayedBranch(branchBranch, TreeLogger.DEBUG, "3", null );
		assertEquals( "" + messages,0, messages.size() );
	...
	public void testThreeBranchesThenOneLeafLogWithLostSecondLevelBranch(){
		...
		final TreeLogger lostBranchBranch = TreeLoggers.delayedBranch(branch, TreeLogger.DEBUG, "2", null );
		assertEquals( "" + messages,0, messages.size() );

		final TreeLogger lostBranchBranchBranch = TreeLoggers.delayedBranch(lostBranchBranch, TreeLogger.DEBUG, "3", null );
		assertEquals( "" + messages,0, messages.size() );
		
		final TreeLogger branchBranch = TreeLoggers.delayedBranch(branch, TreeLogger.DEBUG, "4", null );
		assertEquals( "" + messages,0, messages.size() );

		final TreeLogger branchBranchBranch = TreeLoggers.delayedBranch(branchBranch, TreeLogger.DEBUG, "5", null );
		assertEquals( "" + messages,0, messages.size() );
	...
	public void testTwoDelayedBranches(){
		...
		final TreeLogger firstDelay = TreeLoggers.delayedBranch(capturer, TreeLogger.DEBUG, "1", null );
		assertEquals( "" + messages,0, messages.size() );
		
		final TreeLogger firstDelayBranch = TreeLoggers.delayedBranch(firstDelay, TreeLogger.DEBUG, "2", null );
		assertEquals( "" + messages,0, messages.size() );
		...
		final TreeLogger secondDelay = TreeLoggers.delayedBranch(capturer, TreeLogger.DEBUG, "4", null );
		assertEquals( "" + messages, 3, messages.size() );
		
		final TreeLogger secondDelayBranch = TreeLoggers.delayedBranch(secondDelay, TreeLogger.DEBUG, "5", null );
		assertEquals( "" + messages, 3, messages.size() );
	...
	public void testTwoDelayedBranchesEachWithLostFirstBranches(){
		...
		final TreeLogger lostFirstDelayBranch = TreeLoggers.delayedBranch(firstDelay, TreeLogger.DEBUG, "2", null );
		assertEquals( "" + messages,0, messages.size() );
		
		final TreeLogger firstDelayBranch = TreeLoggers.delayedBranch(firstDelay, TreeLogger.DEBUG, "3", null );
		assertEquals( "" + messages,0, messages.size() );
		...
		final TreeLogger secondDelay = TreeLoggers.delayedBranch(capturer, TreeLogger.DEBUG, "5", null );
		assertEquals( "" + messages, 3, messages.size() );
		
		final TreeLogger lostSecondDelayBranch = TreeLoggers.delayedBranch(secondDelay, TreeLogger.DEBUG, "6", null );
		assertEquals( "" + messages, 3, messages.size() );
		
		final TreeLogger secondDelayBranch = TreeLoggers.delayedBranch(secondDelay, TreeLogger.DEBUG, "7", null );
		assertEquals( "" + messages, 3, messages.size() );
	...
	static class MessageCapturer implements TreeLogger{
		
		MessageCapturer( final List messages ){
			this( ".", messages );
		}
		
		private MessageCapturer( final String prefix, final List messages ){
			super();
		...
		public TreeLogger branch(final TreeLogger.Type type, final String message, final Throwable caught){
			final List messages = this.getMessages();
		...
		void setMessages( final List messages ){
