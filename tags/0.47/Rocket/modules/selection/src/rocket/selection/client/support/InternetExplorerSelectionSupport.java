...
public class InternetExplorerSelectionSupport extends SelectionSupport {
	...
	native protected SelectionEndPoint getStart0() /*-{
	...
	native protected SelectionEndPoint getStart1(final Element element)/*-{
	 var endPoint = null;
	...
	/**
	 * Factory method which creates a SelectionEndPoint and sets its textNode
