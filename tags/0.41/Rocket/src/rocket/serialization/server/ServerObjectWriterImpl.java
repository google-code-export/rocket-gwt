...
abstract public class ServerObjectWriterImpl implements ServerObjectWriter {

	public void write(final Object object, final ObjectOutputStream objectOutputStream) {
		if (null == object) {
			this.writeNull(objectOutputStream);
		} else {
			this.writeType(object, objectOutputStream);
			this.write0(object, objectOutputStream);
		}
	}

	protected void writeNull(final ObjectOutputStream objectOutputStream) {
	...
	abstract protected void write0(final Object object, final ObjectOutputStream objectOutputStream);
}
