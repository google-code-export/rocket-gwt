 ...
 */
public class IntArrayReader extends ObjectReaderImpl implements ObjectReader {

	static public final ObjectReader instance = new IntArrayReader();
	...
	public Object newInstance(final String typeName, final ObjectInputStream objectInputStream) {
		...
		final int[] array = new int[elementCount];
