...
/**
 * A WebPageTestCase includes a list of TestMethods.
 * Because GWT does not support reflection tests must be assembled by a TestSuiteBuilder
 * which in turn returns a List of Test instances.
 * 
 * <h6>Features</h6>
 * <ul>
 * <li>A variety of static fail() and assertXXX() methods are available 
 * and can be used just like Junits equivalent.
 * </li>
 * <li>
 * A test does not need to complete when the test method finishes. Its completion may be
 * delayed via {@link #postponeFinish(int)}. This is useful if something in the near future
 * needs to happen. That mehtod must either fail as normal or call the {@link #finish()}
...
abstract public class Test {       
     ...
     * @throws Exception if anything goes wrong. The test will be marked as having failed
     */
    abstract protected void execute() throws Exception;
    
    /**
     * This method may be invoked to mark a test as completed.
     * This method is automatically called if the test completion was not postponed via
    ...
    /**
     * Returns the name of the test. This will appear in the output of the TestRunner
     * and is used to identify a test with its outcome.
     * @return
     */
    ...
    /**
     * A value in milliseconds for how long the current test has been postponed for. 
     * A zero value indicates that when the current test method returns the next test should be dispatched.
     */
    ...
    /**
     * A list of messages accumulated whilst the test was run.
     * Typically these will be shown if a test fails.
     */
    ...
    public String toString(){
        return super.toString() + ", name: " + this.getName() + ", startTimestamp: " +
        this.startTimestamp + ", endTimestamp: " + this.endTimestamp + ", state: " + state  +
        ", postponedFinishDelay: " + this.postponedFinishDelay;
    }
}
