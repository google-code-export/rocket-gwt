...
public class StyleSheetTest extends WebPageTestRunner implements EntryPoint{
    ...
    protected void testStyleContainsKey0() {
        final Map style = this.getAppleRuleStyle();
    ...
    protected void testStyleContainsKey1() {
        final Map style = this.getAppleRuleStyle();
    ...
    protected void testStylePutStyle0() {
        ...
        Test.assertTrue("Size should have increased by at least one, sizeBefore: " + sizeBefore + ", sizeAfter: "
    ...
    protected void testStylePutStyle1() {
        final Map style = this.getAppleRuleStyle();
        final int sizeBefore = style.size();
    ...
    protected void testStyleRemoveStyle1() {
        final Map style = this.getAppleRuleStyle();
        final int sizeBefore = style.size();
    ...
    protected void testStyleKeySetIsEmpty() {
        final Map style = this.getAppleRuleStyle();
        final Set keys = style.keySet();
        Test.assertFalse("StyleKeySet is empty", keys.isEmpty());
    }

    protected void testStyleKeySetContains0() {
        final Map style = this.getAppleRuleStyle();
        final Set keys = style.keySet();
    ...
    protected void testStyleKeySetContains1() {
        final Map style = this.getAppleRuleStyle();
        final Set keys = style.keySet();
    ...
    protected void testStyleKeySetIterator() {
        final Map style = this.getAppleRuleStyle();
        final Set keys = style.keySet();
    ...
    protected void testStyleValuesCollectionSize() {
        final Map style = this.getAppleRuleStyle();
    ...
    protected void testStyleValuesCollectionIsEmpty() {
        final Map style = this.getAppleRuleStyle();
        final Collection values = style.values();
        Test.assertFalse("StyleValuesCollection is empty", values.isEmpty());
    }

    protected void testStyleValuesCollectionContains0() {
        final Map style = this.getAppleRuleStyle();
        final Collection values = style.values();
    ...
    protected void testStyleValuesCollectionContains1() {
        final Map style = this.getAppleRuleStyle();
        final Collection values = style.values();
    ...
    protected void testStyleValuesCollectionIterator() {
        final Map style = this.getAppleRuleStyle();
        final Collection values = style.values();
    ...
    protected void testStylePropertyValueGetValue() {
    ...
    protected void testStylePropertyValueSetValue() {
        final StylePropertyValue value = (StylePropertyValue) this.getAppleRuleStyle().get(FONT_SIZE);
        Test.assertNotNull(value);
