 ...
 */
public class FloatArrayReader extends ObjectReaderImpl implements ObjectReader {

	static public final ObjectReader instance = new FloatArrayReader();
	...
	public Object newInstance(final String typeName, final ObjectInputStream objectInputStream) {
		...
		final float[] array = new float[elementCount];
