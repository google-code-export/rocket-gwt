...
/**
 * This is a magic class the compiler uses to perform any cast operations that require code.
 */
final class Cast {
    ...
    /**
     * See JLS 5.1.3 for why we do a two-step cast. First we rount to int, then narrow to byte.
     */
    ...
    /**
     * See JLS 5.1.3 for why we do a two-step cast. First we rount to int, then narrow to char.
     */
    ...
    /**
     * See JLS 5.1.3 for why we do a two-step cast. First we rount to int, then narrow to short.
     */
    ...
    /**
     * Unconditionally throw a {@link ClassCastException}. Called from {#link {@link #dynamicCast(Object, int)}.
     */
    ...
    /**
     * Check a statically false cast, which can succeed if the argument is null. Called by compiler-generated code based on static type
     * information.
     */
    ...
    static native JavaScriptObject wrapJSO(JavaScriptObject jso, Object seed) /*-{
     ...
     } catch ( mightFailBecausePrototypeIsNotWritable ){
     }
