...
import rocket.cookie.client.CookieHelper;
...
public class CookiesGwtTestCase extends GWTTestCase {
    ...
    final static String NAME_OF_COOKIE_WHICH_DOESNT_EXIST = "DOESNT_EXIST";

    public String getModuleName() {
        return "rocket.cookie.test.cookies.CookiesGwtTestCase";
    }

    public void testCookieHelperSetGetRemoveCookie() {
        removeAllCookies();

        assertEquals("", CookieHelper.getCookies());

        final String name = APPLE;
        final String value = "Green";

        CookieHelper.setCookie(name + "=" + value);
        final String cookiesAfterSet = CookieHelper.getCookies();
        ...
        final String cookiesAfterRemove = CookieHelper.getCookies();
    ...
    public void testGetNonExistingCookie0() {
        ...
        final Cookie notFound = (Cookie) cookies.get(NAME_OF_COOKIE_WHICH_DOESNT_EXIST);
        assertNull(notFound);
    }
    ...
    public void testGetNonExistingCookie1() {
        ...
        final Cookies cookies = new Cookies();
        final Cookie notFound = (Cookie) cookies.get(APPLE + NAME_OF_COOKIE_WHICH_DOESNT_EXIST);
        assertNull(notFound);
    }
    ...
    public void testGetExistingCookie0() {
        ...
        CookieHelper.setCookie(appleName + CookieConstants.COOKIE_NAME_VALUE_SEPARATOR + appleValue);
        final Cookies cookies = new Cookies();
    ...
    public void testGetExistingCookie1() {
        ...
        CookieHelper.setCookie(appleName + CookieConstants.COOKIE_NAME_VALUE_SEPARATOR + appleValue);
        CookieHelper.setCookie(bananaName + CookieConstants.COOKIE_NAME_VALUE_SEPARATOR + bananaValue);
        CookieHelper.setCookie(carrotName + CookieConstants.COOKIE_NAME_VALUE_SEPARATOR + carrotValue);
    ...
    public void testContainsKeyWithNonExistingCookie() {
        ...
        final Cookies cookies = new Cookies();
        final boolean notFound = cookies.containsKey(NAME_OF_COOKIE_WHICH_DOESNT_EXIST);
    ...
    public void testContainsKeyWithThreeCookies() {
        ...
        assertFalse(cookies.containsKey(NAME_OF_COOKIE_WHICH_DOESNT_EXIST));
    }
    ...
    public void testContainsValueWithNonExistingCookie() {
        ...
        final Cookies cookies = new Cookies();
        final boolean notFound = cookies.containsValue(NAME_OF_COOKIE_WHICH_DOESNT_EXIST);
        assertFalse(notFound);
    }
    ...
    public void testRemoveWhichAttemptsToRemoveANonExistingCookie() {
        ...
        final Cookies cookies = new Cookies();
        final Object removed = cookies.remove(NAME_OF_COOKIE_WHICH_DOESNT_EXIST);
    ...
    public void testRemoveWhichAddsAndThenRemovesThreeDifferentCookies() {
        ...
        final Object shouldBeNullBecauseCookieDoesntExist = cookies.remove(NAME_OF_COOKIE_WHICH_DOESNT_EXIST);
    ...
    public void testIsEmpty() {
        ...
        assertTrue(CookieHelper.getCookies(), cookies.isEmpty());
        ...
        assertFalse(CookieHelper.getCookies(), cookies.isEmpty());
    ...
    public void testValuesCollectionSize() {
        ...
        assertEquals(CookieHelper.getCookies(), 0, values.size());

        final Cookie appleCookie = new Cookie();
        appleCookie.setName(appleName);
        appleCookie.setValue(appleValue);
        cookies.put(appleName, appleCookie);
        assertEquals(CookieHelper.getCookies(), 1, values.size());

        final Cookie bananaCookie = new Cookie();
        bananaCookie.setName(bananaName);
        bananaCookie.setValue(bananaValue);
        cookies.put(bananaName, bananaCookie);
        assertEquals(CookieHelper.getCookies(), 2, values.size());
    ...
    public void testValuesCollectionIteratorCallingExtraNextAfterIteratorIsExhaustedThrowsException() {
        ...
        try {
            ...
            fail("The Cookies.value().iterator() should have thrown an exception because it is empty, object: "
                    + object);
        } catch (final Exception expected) {
    ...
    public void testEntrySetRemove() {
        ...
        carrotCookie.setName(carrotName);
        carrotCookie.setValue(carrotValue);
        assertTrue(CookieHelper.getCookies(), values.remove(appleCookie));

        assertTrue(CookieHelper.getCookies(), values.remove(bananaCookie));

        assertFalse(CookieHelper.getCookies(), values.remove(carrotCookie));

        assertFalse(CookieHelper.getCookies(), values.remove(appleCookie));
    ...
    public void testEntrySetIteratorCallingExtraNextAfterIteratorIsExhaustedThrowsException() {
        ...
        try {
            final Object object = iterator.next();
            fail("The Cookies.entrySet().iterator() should have thrown an exception because it is empty, object: "
                    + object);
        } catch (final Exception expected) {
    ...
    public void testEntrySetIteratorNextFailsFastWhenCookieMapIsModified() {
        ...
        try {
            ...
            fail("The Cookies.entrySet().iterator() should have failed fast (throwing an exception) because the backing Cookies was modified, iterator: "
                    + iterator + ", cookies[" + CookieHelper.getCookies() + "]");
        } catch (final Exception expected) {
        }
    ...
    public void testKeySetAddThrowsException() {
        ...
        try {
            ...
            CookieHelper.removeCookie(appleName);
        }
    }
    ...
    public void testKeySetIteratorCallingExtraNextAfterIteratorIsExhaustedThrowsException() {
        ...
        try {
            final Object object = iterator.next();
            fail("The Cookies.keySet().iterator() should have thrown an exception because it is empty, object: "
                    + object);
        } catch (final Exception expected) {
