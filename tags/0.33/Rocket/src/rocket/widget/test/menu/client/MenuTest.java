...
public class MenuTest implements EntryPoint {
	...
	public void onModuleLoad() {
		...
		final CheckBox openDownwards = new CheckBox("VerticalMenuLists hanging off HorizontalMenuLists open downwards ?");
		openDownwards.setChecked(true);
		this.setOpenDownwards(openDownwards);
		centerPanel.add(openDownwards);

		final CheckBox openRightwards = new CheckBox("VerticalMenuLists hanging off other VerticalMenuLists open rightwards ?");
		...
		createHorizontalMenuBar.addClickListener(new ClickListener() {
			public void onClick(final Widget sender) {
				...
				dockPanel.add(horizontalMenuBar, getOpenDownwards().isChecked() ? DockPanel.NORTH : DockPanel.SOUTH);
			}
		});
