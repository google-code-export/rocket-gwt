...
public class Throwable {
    ...
    /**
     * This field is no longer used as real stack traces are being built and returned in {@link #getStackTrace() }
     * 
     */
    ...
    native private JavaScriptObject setCallStack0(final JavaScriptObject array)/*-{
     array.shift(); // remove the StackTraceHelper.getCallStackFunctions() frame
