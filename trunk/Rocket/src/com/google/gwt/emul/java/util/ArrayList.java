...
// FIXED by Miroslav Pokorny so add( Object ) mimics jdk.
// Original method in error...
//public boolean add(Object o) {
//add(size(),o);
//return true;
//}
// Fixed method included below...
  native public boolean add( final Object object )/*-{
     	var array  = this.@java.util.ArrayList::array;
    	var endIndex = this.@java.util.ArrayList::endIndex;
		
		// save new element.
		array[endIndex] = object;
