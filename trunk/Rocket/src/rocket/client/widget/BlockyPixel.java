...
/**
 * This widget is a panel made up of blocks which can be individually addressed. The actual size of the panel is determined by the space
 * allocated by its parent. Individual blocks may be addressed set/get
 * 
 * Whenever either the rows/columns are set the colours of the grid are lost and all cells must be recoloured/set.
 * 
...
public class BlockyPixel extends Composite implements PixelGrid {
     ...
     * 
     * The corresponding table cell is only updated if the parameter:colour is different!
     * 
     * @param x
     * @param y
     * @param colour
