...
public class DomHelper extends ObjectHelper {
    ...
    /**
     * This method exists only because of a GWT bug within the DOM class. Unfortunately the FF implementation used by DOM was reading the
     * wrong property resulting in null always being returned.
     * 
     * @param event
     * @return
     * 
     * @deprecated This method should only be used until this fix implemented in GWT.
     */
    ...
    // TODO Should probably be deprecated when rocket.client.style.* is completed.
