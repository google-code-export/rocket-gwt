 ...
 * ruleAsText, index ) ignoring the index and appending the rule at the end of the rules list.
 * 
 * @author Miroslav Pokorny (mP)
 */
public class Opera9RuleListImpl extends RuleListImpl {

    public Opera9RuleListImpl() {
        super();
    }
