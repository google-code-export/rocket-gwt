 ...
 * @version 1.0
 */
public class UncheckedNestedException extends AbstractPossiblyNestedUncheckedException {

    public UncheckedNestedException(final Throwable cause) {
        super(cause);
    }

    public UncheckedNestedException(final String message, final Throwable cause) {
        super(message, cause);
    }
