...
import rocket.selection.client.support.*;
...
public class SelectionHelper {
     ...
     * 
     * It is not possible to re enable text selection for a child if a ancestor has been disabled using {@link #disableTextSelection(Element)}
     * @param element
     */
