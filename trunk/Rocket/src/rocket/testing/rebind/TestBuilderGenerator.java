...
/**
 * This generator may be used to create a list containing all the public methods that 
 * start with test. It seeks to emulate the process JUnit performs to find tests.
...
public class TestBuilderGenerator extends Generator {
	...
	/**
	 * Loops thru and discovers all the public test instance methods belonging to
	 * the webPageTestRunner type. For each test method a Test instance is created
	 * @param testBuilder
	...
	protected void throwTestMethodDoesntReturnVoid( final Method method ){
		throw new TestBuilderGeneratorException("The test method should return void and not " + method.getReturnType() + ", method: " + method );
	}
	...
	protected void throwUnableToConvertOrderAnnotationToANumber( final Method method ){
		throw new TestBuilderGeneratorException("The order annotation for method is not a number, method: " + method + " annotation value: " + method.getMetadataValues( Constants.ORDER_ANNOTATION ));
	}
