...
public class MenuTest implements EntryPoint {
	...
	void buildMenuBar(final Menu menuBar, final MenuListOpenDirection openDirection) {
		...
		disabledFruit.setMenuList(createVerticalMenuList(true, MenuListOpenDirection.LEFT == openDirection ? MenuListOpenDirection.LEFT : MenuListOpenDirection.RIGHT ));
	...
	void buildSubMenu(final SubMenuItem subMenuItem, final MenuListOpenDirection openDirection) {
		...
		apples.setMenuList(createVerticalMenuList(true, MenuListOpenDirection.LEFT == openDirection ? MenuListOpenDirection.LEFT : MenuListOpenDirection.RIGHT));
		...
		disabledApples.setMenuList(createVerticalMenuList(true, MenuListOpenDirection.LEFT == openDirection ? MenuListOpenDirection.LEFT : MenuListOpenDirection.RIGHT));
	...
	void buildSubSubMenu(final SubMenuItem subMenuItem, final MenuListOpenDirection openDirection) {
		...
		apple.setMenuList(createVerticalMenuList(true, MenuListOpenDirection.LEFT == openDirection ? MenuListOpenDirection.LEFT : MenuListOpenDirection.RIGHT));
