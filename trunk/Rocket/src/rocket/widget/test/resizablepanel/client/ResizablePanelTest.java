...
/**
 * This test involves creating three ResizablePanels the first with a TextArea,
 * the second with an Image and the last with a SPAN containing some arbitrary
 * html.
 * 
