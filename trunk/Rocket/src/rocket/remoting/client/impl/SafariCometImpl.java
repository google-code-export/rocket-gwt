...
public class SafariCometImpl extends CometImpl {
    /**
     * Because safari does not support an onload event or equivalent a timer is used to poll the status of the iframe.
     */
    ...
    /**
     * This javascript checks and kills the associated onloadPoller function which polls the ready state of the iframe. This is necessary as
     * Safari does not appear to support any of the listener methods used by other implementations.
     * 
     * @param iframe
     */
