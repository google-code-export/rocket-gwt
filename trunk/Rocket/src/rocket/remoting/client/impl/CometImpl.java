 ...
 *
 */
public class CometImpl {
    /**
     * Standards complient browsers register a onload event which is then delegated to the CometClient
     * instance which handles deserialization and calls registered callbacks.
     * @param cometClient
     * @param frame
     */
    ...
    /**
     * Registers a function on the main window which will set the __connected flag on the given iframe to 
     * true when executed.
     * 
     * @param cometClient
     * @param frame
