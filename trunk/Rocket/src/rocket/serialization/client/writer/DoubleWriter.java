...
/**
 * Handles the serialization of a Double wrapper
 * 
...
public class DoubleWriter extends NumberWriter implements ObjectWriter{
	...
	protected DoubleWriter() {
	}

	protected void write0(final Object object, final ObjectOutputStream objectOutputStream) {
		this.writeDouble((Double) object, objectOutputStream);
	}

	protected void writeDouble(final Double wrapper, final ObjectOutputStream objectOutputStream) {
		objectOutputStream.writeDouble(wrapper.doubleValue());
	}
