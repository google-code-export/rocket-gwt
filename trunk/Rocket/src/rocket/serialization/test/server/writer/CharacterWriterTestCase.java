...
public class CharacterWriterTestCase extends ServerTestCase {

	final static String CHARACTER = Character.class.getName();

	final static char CHARACTER_VALUE = 'a';

	public void testWriteCharacter() {
		final TestServerObjectOutputStream output = createObjectOutputStream(CharacterWriter.instance);
