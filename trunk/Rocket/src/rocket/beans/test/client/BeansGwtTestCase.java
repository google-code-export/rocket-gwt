...
import rocket.beans.test.client.factorymethod.BeanWithFactoryMethod;
import rocket.beans.test.client.factorymethod.BeanWithFactoryMethodBeanFactory;
...
public class BeansGwtTestCase extends GeneratorGwtTestCase {
	...
	public void testNotABeanFactory() {
		try {
			...
			assertTrue("" + failed, failed.getCauseType().endsWith("NotABeanFactoryException"));
	...
	public void testMissingBeanId() {
		try {
			...
			assertTrue("" + failed, causeType.equals( SAX_PARSE_EXCEPTION) || causeType.endsWith("BeanIdMissingException"));
		}
	}

	public void testInvalidBeanScope() {
		try {
			assertBindingFailed(GWT.create(BeanWithInvalidScopeBeanFactory.class));
		} catch (final FailedGenerateAttemptException failed) {
			final String causeType = failed.getCauseType();
			assertTrue("" + failed, causeType.equals( SAX_PARSE_EXCEPTION) || causeType.endsWith("InvalidBeanScopeException"));
		}
	}
	...
	public void testBeanClassNotFound() {
		try {
			...
			assertTrue("" + failed, failed.getCauseType().endsWith("BeanTypeNotFoundException") );
		}
	}
	...
	public void testBeanTypeIsNotConcrete() {
		try {
			...
			assertTrue("" + failed, failed.getCauseType().endsWith("BeanTypeNotConcreteException") );
		}
	}
	...
	public void testFactoryMethodNotFound() {
		try {
			...
			assertTrue("" + failed, failed.getCauseType().endsWith("FactoryMethodNotFoundException") );
		}
	}

	public void testFactoryMethod(){
		final BeanFactory factory = (BeanFactory) GWT.create( BeanWithFactoryMethodBeanFactory.class );
		final BeanWithFactoryMethod bean = (BeanWithFactoryMethod ) factory.getBean( "bean" );
		assertNotNull( bean );
	}
	
	public void testInitMethodNotFound() {
		try {
			assertBindingFailed(GWT.create(BeanWithMissingInitMethodBeanFactory.class));
		} catch (final FailedGenerateAttemptException failed) {
			assertTrue("" + failed, failed.getCauseType().endsWith("InitMethodNotFoundException"));
		}
	}

	public void testInitMethod(){
		final BeanFactory factory = (BeanFactory) GWT.create( BeanWithCustomInitMethodBeanFactory.class );
	...
	public void testBooleanProperty() {
		final BeanFactory factory = (BeanFactory) GWT.create(BeanWithBooleanPropertyBeanFactory.class);
	...
	public void testByteProperty() {
		final BeanFactory factory = (BeanFactory) GWT.create(BeanWithBytePropertyBeanFactory.class);
	...
	public void testDoubleProperty() {
		final BeanFactory factory = (BeanFactory) GWT.create(BeanWithDoublePropertyBeanFactory.class);
	...
	public void testCharProperty() {
		final BeanFactory factory = (BeanFactory) GWT.create(BeanWithCharPropertyBeanFactory.class);
		final ClassWithCharProperty bean = (ClassWithCharProperty) factory.getBean("bean");
		assertEquals('a', bean.getCharProperty());
	}

	public void testStringProperty() {
		final BeanFactory factory = (BeanFactory) GWT.create(BeanWithStringPropertyBeanFactory.class);
	...
	public void testListProperty() {
		final BeanFactory factory = (BeanFactory) GWT.create(BeanWithListPropertyBeanFactory.class);
	...
	public void testSetProperty() {
		final BeanFactory factory = (BeanFactory) GWT.create(BeanWithSetPropertyBeanFactory.class);
	...
	public void testMapProperty() {
		final BeanFactory factory = (BeanFactory) GWT.create(BeanWithMapPropertyBeanFactory.class);
	...
	public void testBeanReference() {
		final BeanFactory factory = (BeanFactory) GWT.create(BeanWithAnotherBeanReferenceBeanFactory.class);
		final ClassWithBeanReference bean = (ClassWithBeanReference) factory.getBean("bean");
		assertNotNull(bean);
	...
	public void testRemoteRpcService() {
		...
		final RemoteRpcServiceAsync bean = (RemoteRpcServiceAsync) factory.getBean("bean");
		assertNotNull(bean);
	...
	public void testRemoteJsonService() {
		...
		final RemoteJsonServiceAsync bean = (RemoteJsonServiceAsync) factory.getBean("bean");
		assertNotNull(bean);
