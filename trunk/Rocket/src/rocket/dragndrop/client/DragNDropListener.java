...
public interface DragNDropListener {
	 ...
	 * 
	 * @param widget
	 * @return false to cancel the drag otherwise true lets it happen. If any
	 *         listener returns false the drag is vetoed.
	 */
	boolean onBeforeDragStart(DraggablePanel widget);

	/**
	 * This event is fired each time the user attempts to start a drag of a
	 * draggable widget.
	 * 
	 * @param widget
	 */
	 ...
	 * 
	 * @param widget
	 * @return false to ignore the move. This is useful if the widget has been
	 *         dragged into an invalid region.
	 */
	...
	/**
	 * This event is fired each time a dragged widget is dropped or let go upon
	 * a target.
	 * 
	 * @param dragged
	...
	/**
	 * This event is fired after all listeners have been queried and the drop is
	 * allowed to happen.
	 * 
	 * @param dragged
	 *            The widget being dragged
	...
	/**
	 * This method is fired whenever a drag operation is cancelled by a fellow
	 * listener.
	 * 
	 * @param widget
	 */
	...
	/**
	 * This event is fired each time a widget is dropped over an invalid non
	 * drop zone.
	 * 
	 * @param event
	 * @param widget
