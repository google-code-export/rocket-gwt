...
/**
 * Convenient start for any DragNDropListener in which all its methods do nothing. This is particularly useful when only one method needs to
 * be implemented.
 * 
 * @author Miroslav Pokorny (mP)
 */
public class DragNDropListenerImpl implements DragNDropListener {
