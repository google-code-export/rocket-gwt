...
/**
 * This helper includes a collection of miscellaneous useful methods relating to
 * HTTP.
 * 
...
public class HttpHelper {
	...
	/**
	 * Encodes all the elements belonging to form into a url encoded safe
	 * String.
	 * 
	 * @param form
	 * @return
	...
	/**
	 * Loops thru all the elements belonging to form. Had to be done this way
	 * because I am unsure how to return form.elements. Attempting to return an
	 * array of Elements causes the compiler to generate broken javascript. This
