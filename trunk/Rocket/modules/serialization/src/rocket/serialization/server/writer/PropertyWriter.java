 ...
 * 
 * This class caches the accessible properties for each and every type that it sees.
 * The first time a type is visited the {@link #findGetters(Class)} is called to find or discover all getters after
 * which these are placed in a Map to cache.
