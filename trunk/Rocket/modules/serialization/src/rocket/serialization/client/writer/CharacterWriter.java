...
public class CharacterWriter extends ObjectWriterImpl {
	...
	static public final ObjectWriter instance = new CharacterWriter();

	protected CharacterWriter() {
	}

	protected void write0(final Object object, final ObjectOutputStream objectOutputStream) {
		this.writeCharacter((Character) object, objectOutputStream);
	}

	protected void writeCharacter(final Character wrapper, final ObjectOutputStream objectOutputStream) {
		objectOutputStream.writeChar(wrapper.charValue());
	}
}
