...
public class GwtCometGenerator extends Generator {
	 ...
	 * 
	 * @param newTypeName
	 *            The name of the new type to generate
	 * @param cometClient
	 *            The incoming type
	 ...
	 * 
	 * @param newType
	 *            A nested type that is a gwt rpc service interface
	 ...
	 * 
	 * @param newType
	 *            The nested type that will contain the async service interface
	 */
	...
	protected void throwUnableToFindCometPayloadTypeAnnotation(final Type type) {
		throw new CometClientGeneratorException("Unable to find the annotation \"" + Constants.COMET_PAYLOAD_TYPE_ANNOTATION
				+ "\" on the " + type + "." + Constants.CREATE_GWT_RPC_PROXY_METHOD);
	}
	...
	protected void throwUnableToFindPayloadType(final String type) {
		throw new CometClientGeneratorException("Unable to find the type \"" + type + "\" which was specified by the \""
				+ Constants.COMET_PAYLOAD_TYPE_ANNOTATION + "\" annotation.");
	}
