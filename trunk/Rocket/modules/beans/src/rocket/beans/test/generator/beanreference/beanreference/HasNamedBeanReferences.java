 ...
 * the License.
 */
package rocket.beans.test.generator.beanreference.beanreference;

public class HasNamedBeanReferences {
	private ConcreteClass concreteClass;

	public void setConcreteClass(final ConcreteClass concreteClass) {
