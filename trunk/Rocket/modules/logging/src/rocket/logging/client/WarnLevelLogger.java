 ...
 * infrastructure. By having all logging statements less than warn are empty and
 * thus will be removed from the generated output by the compiler.
 * 
 * @author Miroslav Pokorny
 */
public class WarnLevelLogger extends InfoLevelLogger implements Logger {

	public WarnLevelLogger(Logger logger) {
		super(logger);
	}

	protected WarnLevelLogger() {
		super();
	}
