...
//		  throw new IllegalStateException( "The field:loggerFactoryGetLogger must not be null." );
//	  } // may be null if Logging module is not inherited in which case the method will not be found when all methods are visited etc.
