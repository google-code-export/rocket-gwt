...
public class JavaToJavaScriptCompiler {
  ...
  private void checkForErrors(final TreeLogger logger, boolean itemizeErrors)
	...
	/**
	 * This method has been added by the rocket project to return the correct LoggerOptimiser implementation based upon the value of a property for the
	 * permutation being generated.
	 * 
	 * @param program
	 *            The program or permutation being processed
	 * @param propertyOracle
	 *            The PropertyOracle for the current permutation
	 * @param logger
	 *            A logger
